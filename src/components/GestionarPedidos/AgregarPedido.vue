<template>
  <v-card>
    <v-card-title class="justify-center">Agregar al carrito</v-card-title>
    <div class="container">
      <v-form>
        <v-text-field
          v-model.trim="medicina.nombre"
          label="Descripción"
          outlined
          @input="$v.medicina.nombre.$touch()"
          @blur="$v.medicina.nombre.$touch()"
        ...
        ></v-text-field>
        <v-text-field
          v-model.trim="medicina.cantidad"
          label="Precio"
          @input="$v.medicina.cantidad.$touch()"
          @blur="$v.medicina.cantidad.$touch()"
          height="25"
          rows="2"
