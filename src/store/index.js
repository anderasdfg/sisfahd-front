...
export default new Vuex.Store({
  state: {
    ...
    barImage:
      "https://images.unsplash.com/photo-1584820927498-cfe5211fd8bf?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80",
    drawer: null,
    listaPagos: [],
    listaEspecialidad: [],
    listaUsuario: [],
